...
// ─── Projects ───
const projectsData = [
  { id: 'project-1',  folder: 'ba',               color: '#c0392b', titleEn: 'Ba',                titleRu: 'Ба',                    year: '2026', tags: ['logos', 'branding'],               descEn: '«Ba» is a restaurant built on the model of a Japanese ramen shop — but with Russian soul.<br><br>Task: Create a logo concept for a place where Japanese form meets Russian substance:<br><br>shchi in five varieties instead of ramen<br>fermented vegetables instead of tsukemono<br>salted fish instead of sashimi<br>salo instead of wagyu<br>vodka instead of sake', descRu: '«Ба» — ресторан по модели японского рамен-шопа, но с русской душой.<br><br>Задача: Создать концепцию логотипа для заведения, где японская форма встречает русское содержание:<br><br>вместо рамена — щи (5 видов)<br>вместо цукэмоно — квашения<br>вместо сашими — солёная рыба<br>вместо вагю — сало<br>вместо саке — водка' },
  { id: 'project-2',  folder: 'tula-marathon',    color: '#e67e22', titleEn: 'Tula Marathon',     titleRu: 'Тульский марафон',      year: '2026', tags: ['logos', 'motion'],                 descEn: 'Logo redesign concept and identity for the Tula Marathon.', descRu: 'Концепция редизайна логотипа и айдентика Тульского марафона.' },
  ...
  { id: 'project-21', folder: 'puppai',            color: '#7c5cbf', titleEn: 'PuppAI',            titleRu: 'PuppAI',                year: '2026', tags: ['logos', 'web', 'interactive'],     descEn: 'Logo concept for a pet behaviour and health monitoring service.', descRu: 'Концепция логотипа для сервиса мониторинга поведения и здоровья домашних питомцев.' },
  { id: 'project-4',  folder: 'punk-delicious',   color: '#e91e8c', titleEn: 'Punk Delicious',    titleRu: 'Панк делишс',           year: '2025', tags: ['logos', 'branding'],               descEn: 'Logo and identity concept for a restaurant.', descRu: 'Концепция логотипа и айдентики для ресторана.' },
  { id: 'project-5',  folder: 'coffee-cult',      color: '#a0522d', titleEn: 'Coffee Cult',       titleRu: 'Кофе культ',            year: '2025', tags: ['logos', 'illustration'],           descEn: 'Redesign concept for a coffee brand.', descRu: 'Концепция редизайна кофейного бренда.' },
  ...
  { id: 'project-13', folder: 'strana-sveta',     color: '#7fd6e8', titleEn: 'Strana Sveta',      titleRu: 'Страна света',          year: '2022', tags: ['motion', 'art'],                   descEn: 'Projection mapping concept for a Saint Petersburg facade — finalist of the Strana Sveta festival.', descRu: 'Концепция проекционного маппинга на фасад в Санкт-Петербурге — финалист фестиваля «Страна света».' },
